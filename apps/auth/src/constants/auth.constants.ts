export const AUTH_CONSTANTS = {
    ...
    USER: {
        ...
        DEFAULT_AVATAR_IPFS_HASH: 'bafkreibmridohwxgfwdrju5ixnw26awr22keihoegdn76yymilgsqyx4le',
        DEFAULT_AVATAR_FALLBACK_URL: 'https://res.cloudinary.com/dfzu1b238/image/upload/v1748419831/default_user_icon_rt4zcm.png',
    },
    ...
    // Logging
    LOGGING: {
        SENSITIVE_FIELDS: ['password', 'password_hashed', 'token', 'session_token', 'access_token', 'refresh_token'],
        MASK_CHARACTER: '*',
        MASK_LENGTH: 8,
    },
};
